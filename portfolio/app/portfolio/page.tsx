  ...
  return (
    <>
      <main className="bg-primary overflow-x-hidden">
        ...
        >
          <div className="text-xl ml-1 font-medium font-portfolioTitle text-destructive md:ml-3 md:text-5xl">
            To better understand me, here&apos;s my path and where I am in life
            today
          </div>
          <TimeLine></TimeLine>
        </section>
        ...
        <section id="passions" className="min-h-screen mb-28">
          <div className="text-xl ml-1 mb-20 font-medium font-portfolioTitle text-destructive md:ml-3 md:text-5xl">
        ...
        <section id="projects" className="min-h-screen">
          <div className="text-xl mb-12 ml-1 font-medium font-portfolioTitle text-destructive md:ml-3 md:text-5xl md:mb-20">
